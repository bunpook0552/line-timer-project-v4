...
// ฟังก์ชันนี้ยังคงอยู่นอก `POST` แต่ `messagesMap` ต้องเข้าถึงได้
...
} // <--- วงเล็บปิดของ fetchMessagesFromFirestore ต้องอยู่ตรงนี้!

// ฟังก์ชันสำหรับส่งข้อความตอบกลับพร้อมปุ่ม Quick Reply
// ย้ายฟังก์ชันนี้มาอยู่นอก `fetchMessagesFromFirestore` และสามารถเข้าถึง `db` ได้
...
// ย้ายฟังก์ชันนี้มาอยู่นอก `fetchMessagesFromFirestore` และสามารถเข้าถึง `db` และ `admin` ได้
...
// Route Handler สำหรับ POST request
// ฟังก์ชันนี้ต้องอยู่ในระดับบนสุดของไฟล์ และต้องใช้ `export`
